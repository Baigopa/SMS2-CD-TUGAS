...
import custom.exception.IllegalAdminAccess;
import data.Admin;
import data.Student;
...
public class LibrarySystem extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        // Font Color
        sceneTitle.setStyle("-fx-text-fill: #FFFFFF;"); // Change to white
        usernameLabel.setStyle("-fx-text-fill: #FFFFFF;"); // Change to white
        passwordLabel.setStyle("-fx-text-fill: #FFFFFF;"); // Change to white
        errorLoginMessage.setStyle("-fx-text-fill: #FF1E1E;"); // Red for error
        ...
        loginButtom.setStyle("-fx-background-color: #333333; -fx-text-fill: #FFFFFF;"); // Black background, white text
